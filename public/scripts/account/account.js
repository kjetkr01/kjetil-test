...
async function requestAccountDetails() {
    ...
    if (user) {
        ...
        try {
            ...
            const cachedLiftsLeft = parseInt(localStorage.getItem("cachedLiftsLeft_owner")) || parseInt(sessionStorage.getItem("cachedLiftsLeft_owner"));
            ...
            const cachedTrainingsplitsLeft = parseInt(localStorage.getItem("cachedTrainingsplitsLeft_owner")) || parseInt(sessionStorage.getItem("cachedTrainingsplitsLeft_owner"));

            activetrainingsplit = JSON.parse(localStorage.getItem("cachedActiveTrainingsplit_owner")) || JSON.parse(sessionStorage.getItem("cachedActiveTrainingsplit_owner"));
...
async function displayLifts(hasLiftsLeft) {
    ...
    try {
        ...
        hasLiftsLeft = parseInt(localStorage.getItem("cachedLiftsLeft_owner")) > 0 || parseInt(sessionStorage.getItem("cachedLiftsLeft_owner")) > 0 || false;
...
async function displayGoals(hasGoalsLeft, checkIfCompleted) {
    ...
    try {
        ...
        hasGoalsLeft = parseInt(localStorage.getItem("cachedGoalsLeft_owner")) > 0 || parseInt(sessionStorage.getItem("cachedGoalsLeft_owner")) > 0 || false;
