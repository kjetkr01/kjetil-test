...
const ongoingUpdatesArr = [
    ...
    "Personvern (75%)",
    "TITLE:Treningsplan",
    "Opp til ~5 treningsplaner (100%)",
    "Egendefinert navn per plan (100%)",
    "Elementer: nr, øvelse, reps, sets, % utfra ORM?, rpe, notis (notis er kun for brukeren) (0%)",
    "Kunne lagre/kopiere andre brukere sine planer (0%)",
    "Kunne velge aktiv treningsplan (100%)",
    "Kunne redigere treningsplanen (10%)",
