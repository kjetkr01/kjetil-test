...
const ongoingUpdatesArr = [
    ...
    "TITLE:Treningsplan",
    "Kunne flytte øvelser opp eller ned (100%)",
    "Kunne endre navn på øvelser som allerede er laget (100%)",
    "TITLE:Splash Screen (iOS)",
    "Fikse slik at splash screen funker på landscape mode (iPad) (50%)",
    "TITLE:Medaljer",
    "Vise antall medaljer brukeren har fått (1 mål fullført = 1 medalje) (90%)",
    "TITLE:Språk",
